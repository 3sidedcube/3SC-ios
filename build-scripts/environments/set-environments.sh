...
# Get the file path of the Info.plist file relative to ${DIR}
PLIST_PATH="${XCODE_ROOT_PATH}/Info.plist"
...
# Set API environment
apiEnvironment=$1
plutil -replace "${API_ENVIRONMENT}" -string "${apiEnvironment}" "${PLIST_PATH}"
